...
This directory contains planning documents and historical context for the Cognitive Archaeology Tribunal project.
...
- **[Cognitive OS Master Plan](history/cognitive-os-master-plan.md)** - Complete system architecture vision (9000+ lines)

---

## 🎯 Purpose

This context/ directory serves two purposes:

1. **Planning** - Living documents that track current work and decisions
2. **History** - Preserved context showing how the project evolved
...
│   ├── README.md
│   ├── INTEGRATION_QUEUE.md      ⭐ Start here for integration
│   ├── INGESTION_PLAN.md
│   └── NEXT_STEPS.md
